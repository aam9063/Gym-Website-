...
const featured = [
  {
    ...
    subtitle:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maiores totam distinctio tempore sint recusandae doloremque.',
  },
  {
    icon: <IoIosPricetags />,
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-2 mb-8">
          ...
          >
            ...
            totam distinctio tempore sint recusandae doloremque.
          </motion.p>
        </div>
        {/* Featured items */}
        <motion.div
